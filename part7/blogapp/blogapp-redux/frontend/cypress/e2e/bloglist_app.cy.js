  ...
  describe("When logged in", function () {
    ...
    it("A blog can be created", function () {
      ...
      cy.get(".notif")
        .should(
          "contain",
          "a new blog Things I Don't Know as of 2018 by Dan Abramov added",
        )
    ...
    describe("and a blog exists", function () {
      ...
      it("it can be deleted", function () {
        ...
        cy.get(".notif")
          .should(
            "contain",
            "Things I Don't Know as of 2018 by Dan Abramov was deleted",
          )
          .and("have.css", "color", "rgb(0, 128, 0)");
      ...
      it("it's delete button can only be seen by the creator and not anyone else", function () {
        cy.contains("Matti Luukkainen logged in");
        cy.contains("view").click();
        cy.get(".blog").should("contain", "Matti Luukkainen");
